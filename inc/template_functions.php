...
{
    exit('Vulnerable to XSS, disabled for now!');
    ...
    if (empty($templateOptions)) {
        ...
        <div id="save_template">
            ...
            <p><label class="o_textinput"
                      for="template"><?php _e("Your Current Template:", 'wp-rss-multi-importer') ?></label>
                <?php echo $friendlyfile ?>
            </p>

            <form method="POST" id="template-form">
                <?php _e("Give your current template a unique name:", 'wp-rss-multi-importer') ?> <input type="text"
                                                                                                         id="inputtext"
                                                                                                         value=""
                                                                                                         name="filename">
            ...
            <p>OR</p>
            <button type="button" name="csssave" id="css-save"
                    value=""><?php _e("CLICK TO JUST SAVE CSS FILE", 'wp-rss-multi-importer') ?></button>
        </div>
        <?php
    } else {
