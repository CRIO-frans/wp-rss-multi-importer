...
function fetch_feeds_for_id()
{
    ...
    if (isset($post_id) && preg_match('/^[1-9][0-9]{0,19}$/',$post_id)) {
            ...
            <td>
                <select style="width: 200px" name="rssmi_mediaID">
                    ...
                    <option value="<?php echo $i; ?>"
                        ...
                        <?php echo $i; ?>
                        <?php } ?>
                </select> (for Media Image - selects which media image in the feed's image enclosure. If you choose an
                image number, this will be used over any other image found.
                <a href="http://www.wprssimporter.com/faqs/what-is-the-media-image-number/" target="_blank">Learn more
                    about this here.</a>)
            </td>
        </tr>
